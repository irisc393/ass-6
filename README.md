...
The scaled transformation is needed to be apply, since we need let 0 represent no heart dieases and 1–4 represent have heart disease. Also, there are some missing data, therefore the transformation is needed.
